...
const reviews = [
  ...
  {
    name: 'Michael Okafor',
    text: 'Authentic flavours that reminded me of home. The moin moin and efo riro were perfection. Professional service and everything arrived exactly on time. Highly recommended!',
    rating: 5
  },
  {
    name: 'Emma Williams',
...
export default function Reviews() {
  ...
  return (
    <section id="reviews" className="py-16 lg:py-24 border-b-2 border-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-5xl lg:text-6xl text-[#562B00] mb-4">WHAT PEOPLE SAY</h2>
        ...
        {isMobile ? (
          <div className="relative">
            ...
            <div className="flex justify-center gap-4 mt-8">
              <button
                onClick={prevReview}
                className="bg-[#562B00] text-white px-6 py-3 border-2 border-black neo-shadow font-semibold transition-all hover:bg-[#E2725B] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0_#000]"
              >
                ← PREV
              </button>
              <button
