      ...
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8 fade-in-up visible">
          ...
          <p className="text-lg sm:text-xl text-[var(--color-text-muted)] max-w-lg leading-relaxed">
            Authentic ready meals and pastries made with love. Pre-order your favorite West African dishes for collection or delivery, including nationwide chilled shipping.
          </p>
